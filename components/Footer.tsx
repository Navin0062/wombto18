    ...
    <footer className="bg-white py-24 border-t border-slate-100">
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        <div className="grid grid-cols-1 gap-16 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-8">
            ...
            <p className="text-base font-light text-slate-800 leading-relaxed">
              A registered non-profit organization dedicated to securing the future of the next generation through end-to-end support systems.
            </p>
        ...
        <div className="mt-24 border-t border-slate-100 pt-12 text-center text-sm font-normal text-slate-400">
          <p>© 2024 WombTo18 Foundation. All rights reserved. <span className="text-[var(--brand-blue)]">Registered Charity No. 12345678.</span></p>
        </div>
      </div>
    </footer>
  );
